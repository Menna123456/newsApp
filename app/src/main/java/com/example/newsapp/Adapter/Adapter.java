...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holders , int position) {
        ...
        requestOptions.diskCacheStrategy(DiskCacheStrategy.ALL); // Set of available caching strategies for media.
...
// this class responsible for hold the reference of id's of the view
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{


        TextView title , desc , publishedAt , time , source , author ;
        ImageView imageView ;
